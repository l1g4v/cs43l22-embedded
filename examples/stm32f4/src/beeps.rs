...
async fn main(_spawner: Spawner) {
    ...
    // Configure I2C1 block on pins PB6 and PB9
    let mut i2c = I2c::new_blocking(p.I2C1, p.PB6, p.PB9, Hertz(100_000), Default::default());
    //configure PD4 as output for reset pin for the CS43L22 (STM32F407G-DISC1)
    let reset = Output::new(p.PD4, Level::Low, Speed::High);
    // Create a new CS43L22 device
    ...
    // For this example I2S is not used but it is needed to initialize the CS43L22
